					...
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-40 col-lg-8">
							<div class="title text-center">
								...
								<p>Who are in extremely love with education system.</p>
							</div>
						</div>
					</div>						
				</div>	
			...
			<section class="counter-area">
				<div class="container">
					...
					<div class="row" >
						...
						<div class="col-lg-3 col-md-6">
							<div class="single-counter">
								<h1 class="counter">1560</h1>
								<p>Donated Books</p>								
							</div>
						</div>
						<div class="col-lg-3 col-md-6">
							<div class="single-counter">
								<h1 class="counter">4074</h1>
								<p>Users</p>								
							</div>
						</div>												
					</div>
				...
				<div class="container">
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-60 col-lg-8">
							<div class="title text-center">
								<h1 class="mb-10">Take Any Book You Want</h1>
								<p>Who want to study and lighten themselves.</p>
							</div>
						</div>
					</div>						
					<div class="row">
						...
						<div class="col-lg-4">
							<div class="single-price no-padding">
								...
								<p>
									Who are really want to help <br>
