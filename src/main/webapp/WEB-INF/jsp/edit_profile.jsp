          ...
          <div class="col-md-12">
            <form role="form">
              ...
              <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6">
                  <div class="form-group">
                    <input type="text" name="pincode" id="pincode" class="form-control input-lg" placeholder="Pincode"
                      tabindex="5">
                  </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-6">
                  <div class="form-group">
                    <input type="text" name="phonenumber" id="phone-number" class="form-control input-lg" placeholder="Mobile"
                      tabindex="5">
                  </div>
                </div>
              </div>
